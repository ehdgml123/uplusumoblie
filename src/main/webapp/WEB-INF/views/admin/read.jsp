							...
							<div class="row justify-content-md-center p-5 mb-3">
								<div class="col-md-8">
									<div class="form-group row">
										...
										<div class="col-md-9">
											<input type="text" class="form-control" name="nno" id="nno" readonly value>
										</div>
									</div>
									<div class="form-group row">
										<div class="col-md-2" align="center">
										...
										<div class="col-md-9">
											<input type="text" class="form-control" name="title" id="title" readonly value>
										</div>
									</div>
									<div class="form-group row">
										<div class="col-md-2" align="center">
									...
									<div class="form-group row">
										...
										<div class="col-md-9">
											...
											<input type="text" class="form-control" name="content" id="content" readonly value>
											</div>
										</div>
									</div>
									<div class="form-group row">
										...
										<div class="col-md-4">
											...
											<button type="button" id="listBtn" class="btn btn-primary btn-sm" onclick="location.href='/admin/notice'">목록으로</button>
